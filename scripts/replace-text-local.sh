...
echo "[INFO] Git target revision: $GIT_TARGET_REVISION"
...
export REPO_NAME ORG_NAME VCLUSTER_NAME BASE_DOMAIN GIT_BASE_URL GIT_BASE_URL_AUTHED GIT_PUBLIC_URL GIT_TARGET_REVISION ARGOCD_HOST APP_IMAGE_REPOSITORY IMAGE_REPOSITORY_PREFIX OCI_REGISTRY_HOST SNAPSHOT_OCI_REPOSITORY IMAGE_PULL_SOURCE_SECRET_NAME ONEPASSWORD_VAULT KARGO_ADMIN_PASSWORD_HASH KARGO_TOKEN_SIGNING_KEY KARGO_OIDC_SECRET KARGO_HOST KARGO_WEBHOOK_HOST FORGEJO_OIDC_SECRET FORGEJO_HOST FORGEJO_USERNAME_VALUE
