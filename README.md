...
| [`auto-nodes-aws`](./vcluster-use-cases/auto-nodes-aws/) | Auto-provisions AWS EC2-backed worker nodes for vCluster instances using the vCluster Platform Auto Nodes feature and a Terraform `NodeProvider`. | `Enterprise` | `Yes` | [Repo](./vcluster-use-cases/auto-nodes-aws/README.md) |
